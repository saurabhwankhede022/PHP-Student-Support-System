...
$q=mysqli_query($conn,"select * from faculty where email='$email'");
	...
	{	
		mysqli_query($conn,"insert into faculty values('','$user_name','$name','$Designation','$dept','$sem','$email','$pass','$mob',now(),'0')");
...
<div style="background: black;" class="col-lg-8" style="margin:15px;">
  ...
  <input type="text"  name="dept" value="<?php echo @$prg;?>" class="form-control" required>
        </div>
    </div>

<?php
	...
	mysqli_query($conn,"update hod set Name='$n',designation	='$desg',department='$sem',mobile='$mob',	password='$pass' where id='".$_GET['id']."'");	
...
<div class="col-lg-8" style="margin:15px;">
  ...
  <input type="text"  name="sem" value="<?php echo @$res['department'];?>" class="form-control" required>
        </div>
    </div>

...
<body>
    ...
    <!-- Navigation -->
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation" style="background: #fddc5c">
        <div class="container" >
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php" style="color:#black;"><b>Student Support System</b></a>
	...
	<li class="dropdown">
        ...
        <ul class="dropdown-menu">
		  ...
		  <li><a href="index.php?info=HOD">Head Of Department (HOD IT)</a></li> 
          <li><a href="admin">Principle</a></li> 
        </ul>
      </li> 
...
<?php 
    ...
    <header id="myCarousel" class="carousel slide">
        ...
        <div class="carousel-inner">
            ...
            <div class="item">
                <div class="fill" style="background-image:url('images/build2.jpg');"></div>
                <div class="carousel-caption">
    ...
    <div class="container">
        ...
        <div class="row">
			...
			<div class="col-sm-10" style="margin-top:60px;margin-bottom:80px">
				<h2>About Student support System</h2>
				Student Support system for College in PHP
...
Before we can look into the php code, you need to create a database called "feed" with two tables in it..one as student and another one as take
	...
	<div class="navbar-fixed-bottom nav navbar-inverse text-center" style="padding:15px;height:40px; background: #ffb865">
		<span style="color:#FFFFFF">Developed By SAURABH WANKHEDE </span>
	</div>
    <!-- jQuery -->

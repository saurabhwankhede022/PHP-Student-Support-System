...
$sql=mysqli_query($conn,"select * from faculty_feedback where student_id='$user' and faculty_id='$faculty'");
...
{
$query="insert into faculty_feedback values('','$user','$faculty','$quest1','$quest2','$quest3','$quest4','$quest5','$quest6','$quest7','$quest8','$quest9','$quest10','$quest11','$quest12','$quest13','$quest14',now())";
...
<select name="faculty" class="form-control">
	<?php
$sql=mysqli_query($conn,"select * from faculty where semester='".$users['semester']."' and department='".$users['department']."'");
